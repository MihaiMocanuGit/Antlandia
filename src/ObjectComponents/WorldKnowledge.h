...
private:
    ...
    bool m_indexInWorldWasGiven = false;
...
public:
    ...
    bool willAppearInHomeChunk() const;
...
template <class T>
bool WorldKnowledge<T>::willAppearInHomeChunk() const
{
